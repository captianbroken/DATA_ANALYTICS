              ...
              {filtered.map(event => (
                <tr key={event.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="px-5 py-4 text-right">
                    {event.image_path ? (
                      <a href={event.image_path} target="_blank" rel="noreferrer" className="w-7 h-7 rounded bg-slate-100 inline-flex items-center justify-center hover:bg-slate-200 transition-colors">
